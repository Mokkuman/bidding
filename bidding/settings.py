...
#Used by the alert/flash messages
...
SECRET_KEY = 'django-insecure-$tlt5u+0xmx(@f$%wo^bw@h%*0^60ltdk^dk2rncwhhl!ionjy'
...
#Message tags for alert/flash messages with bootstrap
MESSAGE_TAGS = { 
